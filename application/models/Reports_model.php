...
class Reports_model extends CI_Model{
    ...
    function get_member_upline_today(){
    	$result = $this->db->query("SELECT CONCAT(u.last_name, ', ', u.first_name) AS full_name, c.date_create FROM commission c
    ...
    function withdrawals_today(){
    	$result = $this->db->query("SELECT CONCAT(u.last_name, ', ', u.first_name) AS full_name, w.date_create FROM withdrawal w
